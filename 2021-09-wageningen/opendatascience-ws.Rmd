...
date: '2021-09-10, OpenDataScience Europe Conference'        # 1\. to avoid itemizing
output:
...
.small[<i class="fas fa-info-circle"></i>  Usually one does not split a raster file into train and test - often the train set is composed from point observations and a raster is used for predictions into unknown space.]
...
```{r mlr3spatial-ex-3, warning=FALSE, results=FALSE}
...
```{r mlr3spatiotempcv-ex3, fig.retina=1, dpi=150, fig.dim=c(8, 3)}
...
- Literature: [Roberts et al. 2017](https://onlinelibrary.wiley.com/doi/10.1111/ecog.02881), [Schratz et al. 2019](http://www.sciencedirect.com/science/article/pii/S0304380019302145)
...
# rstudioapi::jobRunScript(here::here("talks/2021-09-10-opendatascience-ws/assets/create-pdf.R"))
```
